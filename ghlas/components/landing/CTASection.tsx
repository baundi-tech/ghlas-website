  ...
  return (
    <section className="py-24 bg-gradient-to-r from-neutral-warmCream to-neutral-paleMint">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex p-4 bg-brand-darkForest rounded-2xl mb-6 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/register" className="btn-accent inline-flex items-center gap-2 text-lg px-8 py-3 group">
              Register Now
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/contact" className="btn-secondary inline-flex items-center gap-2 text-lg px-8 py-3 group">
