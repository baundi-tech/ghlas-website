        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-block px-4 py-2 bg-accent-golden/20 backdrop-blur-sm rounded-full mb-6"
            >
              <span className="text-accent-golden font-medium">Powered by Blockchain</span>
            </motion.div>
